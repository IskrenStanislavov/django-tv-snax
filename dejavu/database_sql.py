...
class SQLDatabase(Database):
    ...
    SONGS_TABLENAME = "audio"

    # fields
    FIELD_HASH = "hash"
    FIELD_SONG_ID = "audio_id"
    FIELD_OFFSET = "offset"
    FIELD_SONGNAME = "name"
    FIELD_FINGERPRINTED = "fingerprintStatus"
    FIELD_HASHES_NUMBER = "fingerprintHashes"
    ...
    # update
    UPDATE_NUMBER_OF_HASHES = """
        UPDATE %s SET %s = %%s WHERE %s = %%s
    """ % (SONGS_TABLENAME, FIELD_HASHES_NUMBER, FIELD_SONG_ID)
    ...
    def insert_song(self, songname):
        ...
        """
        with self.cursor() as cur:
            cur.execute(self.INSERT_SONG, (songname.encode('utf-8'),))
    ...
    def insert_hashes(self, sid, hashes):
        ...
        # with self.cursor() as cur:
            cur.execute(self.UPDATE_NUMBER_OF_HASHES, (len(hashes), sid,))
